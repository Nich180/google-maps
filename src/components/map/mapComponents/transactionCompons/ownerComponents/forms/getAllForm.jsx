...
import EnhancedTable from "../getAllOwners/ownersListTable";
...
class GetAllOwner extends React.Component {
  constructor(props) {
    super(props);
  }
...
GetAllOwner.propTypes = {
  classes: PropTypes.object.isRequired
};

export default withStyles(styles)(GetAllOwner);
