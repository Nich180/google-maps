...
class ContactModificationOptions extends React.Component {
  constructor(props) {
    super(props);
  }
...
ContactModificationOptions.propTypes = {
  classes: PropTypes.object.isRequired
};

export default withStyles(styles)(ContactModificationOptions);
