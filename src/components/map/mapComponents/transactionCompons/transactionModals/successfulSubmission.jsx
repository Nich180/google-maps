...
class SuccessfulSubmission extends React.Component {
  ...
  render() {
    const { classes, returnBack, isSuccessful } = this.props;
    return (
      <React.Fragment>
            ...
            {isSuccessful ? (
              <React.Fragment>
                <Grid item xs={12} className={classes.SuccessfulHeaderStyle}>
                  ...
                  >
                    <div style={{ marginRight: `25px`, display: `-webkit-inline-box` }}>
              ...
              <React.Fragment>
                ...
                <Grid item xs={12}>
                  ...
                  >
                    Text description about either the success or failure or the
                    submission
                  </div>
                </Grid>
              </React.Fragment>
...
export default withStyles(styles)(SuccessfulSubmission);
