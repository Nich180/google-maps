...
class StatusTasksOptions extends React.Component {
  constructor(props) {
    super(props);
  }
            ...
            <List component="nav">
              ...
              <ListItem button >
                ...
                <ListItemText
                  inset
                  primary="Overview"
                  secondary="View overview of building status"
                />
              </ListItem>
              <Divider variant="middle" />
              <ListItem button >
                ...
                <ListItemText
                  inset
                  primary="Building Contacts"
                  secondary="View building contacts status"
                />
              </ListItem>
              <Divider variant="middle" />
            </List>
...
StatusTasksOptions.propTypes = {
  classes: PropTypes.object.isRequired
};

export default withStyles(styles)(StatusTasksOptions);
